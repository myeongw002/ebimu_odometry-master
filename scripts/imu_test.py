...
def talker():
    ...
    '''
    ser.write(b'<soa2>') # set local accel w/o gravity output
    ...
    '''
    ser.write(b'<sor100>') # set output rate to 100ms = 10hz
    ...
    prev_str = ser.readline().decode() # when prev_str is bad input -> :(
